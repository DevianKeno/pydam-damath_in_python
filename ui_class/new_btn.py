...
class NButton:
    ...
    def __init__(self, surface: pygame.Surface, 
                    ...
                    shadow_toggled_color=(149, 49, 30), fontsize: int = 0, 
                    fontstyle = 'font\CookieRun_Regular.ttf', shadow_offset: int=0, 
                    target: Callable = None, args: Iterable=[]): 
                    """
    ...
    def draw(self, pos: tuple=None):
        ...
        pygame.draw.rect(self.surface, self.states[self.get_state()][2], self.btn_shadow_rect, border_radius=self.border_radius)
        pygame.draw.rect(self.surface, self.states[self.get_state()][0], self.btn_rect, border_radius=self.border_radius)
